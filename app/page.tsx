      ...
      <div className="relative rounded-xl w-full h-screen max-h-[90vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <div className="max-w-3xl">
            <h1 className="text-6xl font-bold text-orange-600 mb-6 p-6 border-2 rounded-lg border-indigo-100">
      ...
      <section className="max-w-6xl mx-auto grid gap-6 sm:grid-cols-2 px-4">
        <div className="bg-black rounded-xl p-6 sm:p-8 shadow-white shadow hover:shadow-cyan-600 transition-shadow mt-5">
          ...
          <div className="text-sm sm:text-base text-gray-400 space-y-4">
            <p>Founded in 2020, Nallamala House has been a cornerstone of academic excellence and cultural diversity for over 4 years.</p>
            <p>Named after the ancient Nallamala forest range, our house embodies the strength, resilience, and natural harmony that the region represents.</p>
            <p>Through the years, we've fostered countless leaders, innovators, and changemakers who continue to make their mark globally.</p>
          </div>
        </div>
        ...
        <div className="bg-black rounded-xl p-6 sm:p-8 shadow-white shadow hover:shadow-indigo-600 transition-shadow mt-5">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-8 text-white">
            {[{ label: "Rank", value: "2" }, { label: "Members", value: "4000" }, { label: "Alumni", value: "50" }, { label: "Clubs & Societies", value: "10" }, { label: "Events", value: "100+" }, { label: "Awards", value: "20+" }].map((stat, index) => (
              <div key={index}>
      ...
      <section className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {communities.map((community, index) => (
            <div key={index} className="bg-transparent rounded-lg shadow shadow-white hover:shadow-green-600 transition-shadow overflow-hidden">
              <Image
                src={community.image}
                alt={community.title}
